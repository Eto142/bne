...
<p class="muted" style="color:#555555;">
    ...
    <strong class="gold" style="color:#c9a24d;">Brainznation Entertainment</strong>.
...
<table width="100%" cellpadding="0" cellspacing="0" role="presentation">
<tr>
<td style="padding:8px 0; width:120px; color:#777777;">Email</td>
<td>{{ $appointment->email }}</td>
</tr>
<tr>
<td style="padding:8px 0; color:#777777;">Phone</td>
<td>{{ $appointment->phone }}</td>
</tr>
<tr>
<td style="padding:8px 0; color:#777777;">Purpose</td>
<td>{{ ucfirst(str_replace('_',' ', $appointment->topic)) }}</td>
</tr>
</table>
...
<p style="margin:30px 0 0;">
    Best regards,<br>
    <strong>Brainznation Entertainment</strong>
</p>
