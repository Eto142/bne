                ...
                <tr>
                    <td style="padding:40px; color:#e5e7eb; font-size:15px; line-height:1.8;">
                        ...
                        <p style="margin:0 0 18px;">
                            Hello <strong style="color:#f9fafb;">{{ $application->name }}</strong>,
                        </p>

                        <p style="margin:0 0 30px; color:#d1d5db;">
                            Thank you for applying to the <strong>Brainznation Music Academy</strong>.
                            We’ve successfully received your application and details.
                        </p>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td style="padding:22px;">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                        <tr>
                                            <td style="padding:8px 0; width:160px; color:#9ca3af;">
                                                Area of Interest
                                            </td>
                        ...
                        <p style="margin:30px 0 0; color:#d1d5db;">
                            Our academy team will review your application carefully.
                            If shortlisted, we’ll contact you with the next steps.
                        </p>

                        <p style="margin:30px 0 0;">
                            Best regards,<br>
                            <strong style="color:#ffffff;">The Academy Team</strong><br>
