                ...
                <tr>
                    <td style="padding:40px; color:#e5e7eb; font-size:15px; line-height:1.8;">
                        ...
                        <p style="margin:0 0 18px;">
                            Hello <strong style="color:#f9fafb;">{{ $requestData->name }}</strong>,
                        </p>

                        <p style="margin:0 0 30px; color:#d1d5db;">
                            Your request to speak with management has been successfully received and logged.
                        </p>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td style="padding:22px;">
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                        <tr>
                                            <td style="padding:8px 0; width:120px; color:#9ca3af;">Reason</td>
                        ...
                        <p style="margin:30px 0 0; color:#d1d5db;">
                            Our management team will review your message and follow up if further discussion is required.
                        </p>

                        <p style="margin:30px 0 0;">
                            Respectfully,<br>
                            <strong style="color:#ffffff;">Management Team</strong><br>
