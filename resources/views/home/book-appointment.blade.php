...
<section class="appointment-section" style="padding: 50px 0;">
    <div class="container">

        <!-- Page Title -->
        <div class="section-title" style="text-align: center; margin-bottom: 25px;">
            <h2 style="font-size: 34px; letter-spacing: 1px;">Book an Appointment</h2>
        </div>
        ...
        ">
            ...
            <br><br>
            Fill out the form below to schedule an appointment, and a management representative will respond promptly.
        </p>
...
@endif
    ...
    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="message" name="message" rows="5" placeholder="Provide more details about your appointment..." required></textarea>
                    </div>
